...
//            Twilio.init(accountSID, accountAuthToken);
    ...
    private void sendMsg(String smsText, String mobileNumber) {
        ...
        publishRequest.setMessage(smsText);
        publishRequest.setPhoneNumber(mobileNumber);
...
//            Twilio.init(accountSID, accountAuthToken);
            ...
            String smsText = "Your Order No: " + invoice + "is placed successfully.Contact For Enquiry - 9944370922.";
